...
date: '2021-01-18'
description: 'Use Multer with Node.js and Express to accept multipart/form-data, persist uploads, and store metadata in MongoDB—from HTML forms through API routes and the database.'
cover: '/assets/uploading-files-using-multer-in-a-nodejs-application/hero.jpg'
coverAlt: 'Editor view of the Node.js app used in the Multer file-upload tutorial'
tags:
  - Node.js
  - Multer
  - File upload
...
![package.json](/assets/uploading-files-using-multer-in-a-nodejs-application/json.png)
...
![app.js](/assets/uploading-files-using-multer-in-a-nodejs-application/appjs.png)
...
![app.js](/assets/uploading-files-using-multer-in-a-nodejs-application/appjs2.png)
...
#### Updated app.js File
![app.js3](/assets/uploading-files-using-multer-in-a-nodejs-application/appjs3.png)
...
![atlas](/assets/uploading-files-using-multer-in-a-nodejs-application/atlas.png)
